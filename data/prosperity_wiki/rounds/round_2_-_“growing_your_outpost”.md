...
Example Extra Market AccessOrder book for participants with no extra market access:
(ask, 10 volume, $9)
(ask, 10 volume, $7)
(bid, 10 volume, $5)
(bid, 5 volume, $4)Order book for participants with extra market access:
(ask, 10 volume, $9)
...
Example Bidding MechanismBids:           [10,   20,  15,   19,   21,   34]
Accepted:  [No, Yes, No, No, Yes, Yes]
Explanation: the median of the bids is 19.5, so all bids higher (20, 21, 34) are accepted → these participants get extra market access flow while paying the price they bid, and all bids below 19.5 are rejected (and these participants do not pay the fee).

For those with full market access (i.e. those in the top 50% of bids),
profit = profit from round 2 - bid for getting full market access.For those with no full market access,
profit = profit from round 2.
...
ℹ️For those with full market access (i.e. those in the top 50% of bids),
profit = profit from round 2 - bid for getting full market access.For those with no full market access,
profit = profit from round 2.
...
ℹ️PnL = (Research × Scale × Speed) − Budget_Used
